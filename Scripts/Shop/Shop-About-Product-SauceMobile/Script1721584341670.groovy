...
WebUI.click(findTestObject('Object Repository/Shop/Page_Sauce Labs Cross Browser Testing, Sele_e8ee84/div_Sauce Mobile'))

WebUI.verifyElementText(findTestObject('Object Repository/Shop/Page_Mobile Testing for iOS, Android Apps, _15f976/h1_MOBILE APP TESTING'), 
    'MOBILE APP TESTING')

WebUI.verifyElementText(findTestObject('Object Repository/Shop/Page_Mobile Testing for iOS, Android Apps, _15f976/h2_Deliver seamless mobile app experiences _706d96'), 
