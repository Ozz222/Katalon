...
WebUI.click(findTestObject('Object Repository/Shop/Page_Sauce Labs Cross Browser Testing/div_Platform for Test'))

WebUI.verifyElementText(findTestObject('Object Repository/Shop/Page_Sauce Labs Products Automated Testing _2d1b12/h1_PLATFORM FOR TEST'), 
    'PLATFORM FOR TEST')

WebUI.verifyElementText(findTestObject('Object Repository/Shop/Page_Sauce Labs Products Automated Testing _2d1b12/h2_The unified platform for automated testi_5ea84f'), 
