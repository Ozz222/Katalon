...
WebUI.click(findTestObject('Object Repository/Shop/Page_Sauce Labs Cross Browser Testing, Sele_e8ee84/div_Sauce Visual'))

WebUI.verifyElementText(findTestObject('Object Repository/Shop/Page_UI and Visual Testing Tool  Sauce Labs/h2_Deliver apps that look their best'), 
    'Deliver apps that look their best')

WebUI.verifyElementText(findTestObject('Object Repository/Shop/Page_UI and Visual Testing Tool  Sauce Labs/h1_UIVISUAL TESTING'), 
    'UI/VISUAL TESTING')
