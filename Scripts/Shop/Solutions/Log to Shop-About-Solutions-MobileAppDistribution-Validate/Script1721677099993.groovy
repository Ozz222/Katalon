...
WebUI.click(findTestObject('Object Repository/Shop/Page_Sauce Labs Cross Browser Testing/span_Mobile app distribution'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementText(findTestObject('Object Repository/Shop/Page_Mobile App Distribution/h1_APP CENTER ALTERNATIVE'), 
