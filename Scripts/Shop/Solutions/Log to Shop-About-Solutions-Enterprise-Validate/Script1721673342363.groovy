...
WebUI.click(findTestObject('Object Repository/Shop/Page_Sauce Labs Cross Browser Testing/div_Enterprise'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementText(findTestObject('Object Repository/Shop/Page_Enterprise Testing Solutions From Sauce Labs/h1_ENTERPRISE TESTING SOLUTIONS'), 
