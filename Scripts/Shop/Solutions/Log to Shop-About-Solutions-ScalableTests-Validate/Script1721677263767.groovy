...
WebUI.click(findTestObject('Object Repository/Shop/Page_Sauce Labs Cross Browser Testing/span_Scalable test automation'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementText(findTestObject('Object Repository/Shop/Page_Scalable Test Automation  Sauce Labs/h1_SCALABLE TEST AUTOMATION'), 
    'SCALABLE TEST AUTOMATION')
