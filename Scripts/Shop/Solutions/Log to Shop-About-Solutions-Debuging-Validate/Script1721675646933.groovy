...
WebUI.verifyElementText(findTestObject('Object Repository/Shop/Page_Sauce Labs Cross Browser Testing/span_Debugging'), 'Debugging')

WebUI.click(findTestObject('Object Repository/Shop/Page_Sauce Labs Cross Browser Testing/span_Debugging'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementText(findTestObject('Object Repository/Shop/Page_Intelligent Software Debugging  Sauce Labs/h1_INTELLIGENT SOFTWARE DEBUGGING'), 
    'INTELLIGENT SOFTWARE DEBUGGING')
