...
WebUI.click(findTestObject('Object Repository/Shop/Page_Sauce Labs Cross Browser Testing/span_Test automation'), FailureHandling.STOP_ON_FAILURE)

WebUI.navigateToUrl('https://docs.saucelabs.com/basics/integrations-overview/#automation-tools')

WebUI.verifyElementText(findTestObject('Object Repository/Shop/Page_Getting Started with Sauce Labs Integr_e47490/div_Selenium'), 
    'Selenium')
