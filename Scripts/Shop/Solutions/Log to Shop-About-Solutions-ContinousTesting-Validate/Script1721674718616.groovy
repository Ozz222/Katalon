...
WebUI.click(findTestObject('Object Repository/Shop/Page_Sauce Labs Cross Browser Testing/span_Continuous testing'), FailureHandling.STOP_ON_FAILURE)

WebUI.navigateToUrl('https://docs.saucelabs.com/ci/')

WebUI.verifyElementText(findTestObject('Object Repository/Shop/Page_Incorporating Sauce Labs in Your CI Pi_d592fe/h1_Incorporating Sauce Labs in Your CI Pipeline'), 
    'Incorporating Sauce Labs in Your CI Pipeline')
