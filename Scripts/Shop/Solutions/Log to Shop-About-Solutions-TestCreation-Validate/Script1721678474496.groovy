...
WebUI.click(findTestObject('Object Repository/Shop/Page_Sauce Labs Cross Browser Testing/span_Test creation'), FailureHandling.STOP_ON_FAILURE)

WebUI.navigateToUrl('https://docs.saucelabs.com/basics/integrations-overview/#low-codeno-codemodel-based-test-case-generation')

WebUI.verifyElementText(findTestObject('Object Repository/Shop/Page_Getting Started with Sauce Labs Integr_e47490/h2_Low-codeNo-codeModel-based Test Case Generation'), 
