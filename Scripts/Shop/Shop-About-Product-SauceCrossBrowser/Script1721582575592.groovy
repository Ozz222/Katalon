...
WebUI.click(findTestObject('Object Repository/Shop/Page_Sauce Labs Cross Browser Testing, Sele_e8ee84/span_Sauce Cross-Browser'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Cross Browser Testing Tool/h1_CROSS-BROWSER TESTING'), 'CROSS-BROWSER TESTING')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Cross Browser Testing Tool/h2_Test your apps and websites on every bro_c39d6f'), 
