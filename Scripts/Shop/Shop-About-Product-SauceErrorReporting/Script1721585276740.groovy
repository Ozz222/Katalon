...
WebUI.click(findTestObject('Object Repository/Shop/Page_Sauce Labs Cross Browser Testing, Sele_e8ee84/div_Sauce Error Reporting'))

WebUI.verifyElementText(findTestObject('Object Repository/Shop/Page_App Monitoring  Error Reporting With B_9f2293/h1_ERROR AND CRASH REPORTING WITH BACKTRACE'), 
    'ERROR AND CRASH REPORTING WITH BACKTRACE')

WebUI.verifyElementText(findTestObject('Object Repository/Shop/Page_App Monitoring  Error Reporting With B_9f2293/h2_Find and fix errors before users experie_d2c260'), 
    'Find and fix errors before users experience them')
