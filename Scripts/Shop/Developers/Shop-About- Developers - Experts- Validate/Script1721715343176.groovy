...
WebUI.click(findTestObject('Object Repository/Shop/Developer/Page_Sauce Labs Cross Browser Testing, Sele_e8ee84/div_Meet our experts'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementText(findTestObject('Object Repository/Shop/Developer/Page_Test Automation Experts  Sauce Labs/h1_ASK THE TEST AUTOMATION EXPERTS'), 
    'ASK THE TEST AUTOMATION EXPERTS')
