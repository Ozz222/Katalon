...
WebUI.click(findTestObject('Object Repository/Shop/Developer/Page_Sauce Labs Cross Browser Testing, Sele_e8ee84/div_CI'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.navigateToUrl('https://docs.saucelabs.com/ci/')

WebUI.verifyElementText(findTestObject('Object Repository/Shop/Developer/Page_Incorporating Sauce Labs in Your CI Pi_d592fe/h1_Incorporating Sauce Labs in Your CI Pipeline'), 
