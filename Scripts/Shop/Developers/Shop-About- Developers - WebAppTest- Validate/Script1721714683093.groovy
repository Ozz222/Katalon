...
WebUI.click(findTestObject('Object Repository/Shop/Developer/Page_Sauce Labs Cross Browser Testing, Sele_e8ee84/div_Web app testing'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.navigateToUrl('https://docs.saucelabs.com/web-apps/')

WebUI.verifyElementText(findTestObject('Object Repository/Shop/Developer/Page_Web App Testing  Sauce Labs Documentation/h1_Web App Testing'), 
    'Web App Testing')
