...
WebUI.click(findTestObject('Object Repository/Shop/Developer/Page_Sauce Labs Cross Browser Testing, Sele_e8ee84/div_Cypress'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.navigateToUrl('https://docs.saucelabs.com/web-apps/automated-testing/cypress/quickstart/')

WebUI.verifyElementText(findTestObject('Object Repository/Shop/Developer/Page_Cypress Quickstart  Sauce Labs Documentation/h1_Cypress Quickstart'), 
    'Cypress Quickstart')
