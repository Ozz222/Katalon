...
WebUI.click(findTestObject('Object Repository/Shop/Developer/Page_Sauce Labs Cross Browser Testing, Sele_e8ee84/div_Selenium'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.navigateToUrl('https://docs.saucelabs.com/web-apps/automated-testing/selenium/quickstart/')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Selenium Quickstart  Sauce Labs Documentation/h1_Selenium Quickstart'), 
    'Selenium Quickstart')
