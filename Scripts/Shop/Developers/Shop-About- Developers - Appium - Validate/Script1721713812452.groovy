...
WebUI.click(findTestObject('Object Repository/Shop/Developer/Page_Sauce Labs Cross Browser Testing, Sele_e8ee84/div_Appium'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.navigateToUrl('https://docs.saucelabs.com/mobile-apps/automated-testing/appium/quickstart/')

WebUI.verifyElementText(findTestObject('Object Repository/Shop/Developer/Page_Appium Quickstart  Sauce Labs Documentation/h1_Appium Quickstart'), 
    'Appium Quickstart')
