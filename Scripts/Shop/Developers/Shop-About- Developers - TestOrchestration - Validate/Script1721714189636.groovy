...
WebUI.click(findTestObject('Object Repository/Shop/Developer/Page_Sauce Labs Cross Browser Testing, Sele_e8ee84/div_Test orchestration'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.navigateToUrl('https://docs.saucelabs.com/orchestrate/')

WebUI.verifyElementText(findTestObject('Object Repository/Shop/Developer/Page_Sauce Orchestrate  Sauce Labs Documentation/h1_Sauce Orchestrate'), 
    'Sauce Orchestrate')
