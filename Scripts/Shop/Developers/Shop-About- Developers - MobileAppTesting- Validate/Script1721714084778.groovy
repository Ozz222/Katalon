...
WebUI.click(findTestObject('Object Repository/Shop/Developer/Page_Sauce Labs Cross Browser Testing, Sele_e8ee84/div_Mobile app testing'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.navigateToUrl('https://docs.saucelabs.com/mobile-apps/')

WebUI.verifyElementText(findTestObject('Object Repository/Shop/Developer/Page_Mobile App Testing  Sauce Labs Documentation/h1_Mobile App Testing'), 
    'Mobile App Testing')
