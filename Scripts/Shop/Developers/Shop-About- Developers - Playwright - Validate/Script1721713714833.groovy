...
WebUI.click(findTestObject('Object Repository/Shop/Developer/Page_Sauce Labs Cross Browser Testing, Sele_e8ee84/div_Playwright'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.navigateToUrl('https://docs.saucelabs.com/web-apps/automated-testing/playwright/quickstart/')

WebUI.verifyElementText(findTestObject('Object Repository/Shop/Developer/Page_Playwright Quickstart  Sauce Labs Docu_7bc123/h1_Playwright Quickstart'), 
