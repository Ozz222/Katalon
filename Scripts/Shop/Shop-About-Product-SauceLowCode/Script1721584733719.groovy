...
WebUI.click(findTestObject('Object Repository/Shop/Page_Sauce Labs Cross Browser Testing, Sele_e8ee84/div_Sauce Low-Code'))

WebUI.verifyElementText(findTestObject('Object Repository/Shop/Page_AI-driven Low-Code and No-Code Testing/h1_LOW-CODE TESTING'), 
    'LOW-CODE TESTING')

WebUI.verifyElementText(findTestObject('Object Repository/Shop/Page_AI-driven Low-Code and No-Code Testing/h2_Low-code test automation accelerated'), 
